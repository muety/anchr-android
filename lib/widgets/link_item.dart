      ...
      children: <Widget>[
        Expanded(
          ...
          title: Padding(
            ...
            child: Text(link.description.isEmpty ? Strings.labelNoLinkDescription : link.description, maxLines: 1, overflow: TextOverflow.ellipsis),
          ),
          subtitle: Text(
            link.url,
              ...
              builder: (context) => Column(
                    ...
                    children: <Widget>[
                      ...
                      ListTile(
                          ...
                          title: const Text(Strings.labelShareButton),
                          onTap: () {
